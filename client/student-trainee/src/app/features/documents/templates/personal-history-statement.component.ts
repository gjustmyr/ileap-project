      ...
      <table class="form-table">
        ...
        <tr class="header-row">
          <td class="logo-cell" colspan="2">
            <img src="/assets/img/logo.png" alt="Batangas State University Logo" class="logo" />
          </td>
            ...
            <div class="name-wrapper">
              ...
              <div class="field-container name-fields">
                <span class="field-input">
                  <span class="keep-underline">{{ data?.last_name || '&nbsp;' }}</span>
                  <span class="field-sublabel">LAST</span>
                </span>
                <span class="field-input">
                  <span class="keep-underline">{{ data?.first_name || '&nbsp;' }}</span>
                  <span class="field-sublabel">FIRST</span>
                </span>
                <span class="field-input">
                  <span class="keep-underline">{{ data?.middle_name || '&nbsp;' }}</span>
        ...
        <tr>
          ...
          <td class="field-row" colspan="11">
            ...
            <label><input type="checkbox" [checked]="data?.sex === 'Male'" /> MALE</label>
            <label><input type="checkbox" [checked]="data?.sex === 'Female'" /> FEMALE</label>
          </td>
        </tr>
        ...
        <tr>
          <td class="field-row" colspan="6">
            ...
            <span>&nbsp;{{ data?.height ? data.height + ' cm' : '&nbsp;' }}</span>
          </td>
          <td class="field-row" colspan="6">
        ...
        <tr>
          <td class="field-row birthdate-cell" colspan="9">
            ...
            <div class="date-boxes">
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(0)" readonly />
                <div class="date-label">m</div>
              </div>
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(1)" readonly />
                <div class="date-label">m</div>
              </div>
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(2)" readonly />
                <div class="date-label">d</div>
              </div>
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(3)" readonly />
                <div class="date-label">d</div>
              </div>
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(4)" readonly />
                <div class="date-label">y</div>
              </div>
              <div>
                <input type="text" maxlength="1" class="date-box" [value]="getBirthdateDigit(5)" readonly />
                <div class="date-label">y</div>
              </div>
            </div>
          </td>
        ...
        <tr>
          <td class="field-row" colspan="14">
            ...
            <span>&nbsp;{{ data?.provincial_address || data?.present_address || '&nbsp;' }}</span>
          </td>
          <td class="field-row" colspan="6">
            <span class="field-label">TEL. NO.</span>
        ...
        <tr>
          <td class="section-header" colspan="20">
            <strong>Family Background</strong> (if parents are deceased, give data for the nearest relative and indicate relationship to applicant)
          </td>
        </tr>
        ...
        <tr>
          <td class="field-row" colspan="12">
            ...
            <span>&nbsp;{{ data?.parents_address || data?.present_address || '&nbsp;' }}</span>
          </td>
          <td class="field-row" colspan="8">
            <span class="field-label">TEL. NO.:</span>
        ...
        <tr>
          <td class="certification-text" colspan="20">
            I hereby certify that the foregoing answers are true and correct to the best to my knowledge, belief and ability.
          </td>
        </tr>
        ...
        <tr class="signature-row">
          <td class="signature-cell signed-at-cell" colspan="11">
            Signed at:
            <span class="keep-underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
          </td>
        ...
        <tr>
          <td class="signature-line" colspan="20">
            <div class="signature-border">{{ data?.first_name }} {{ data?.middle_name }} {{ data?.last_name }}</div>
