    ...
    <div class="document-wrapper">
      ...
      <table class="form-table">
          ...
          <td colspan="20" class="content-text">
            <p style="margin: 0 0 0 50px;">
              ...
              <u
                ...
                {{ data?.last_name }}</u
              >
              a <u>{{ data?.year_level }}</u> year
            </p>
            <p style="margin: 0 0 0 50px; font-style: italic; font-size: 9pt;">
              <span style="margin-left: 300px;">Name of Student</span
              ><span style="margin-left: 150px;">Year Level</span>
            </p>
            <p style="margin: 8px 0 0 0;">
              <u>{{ data?.program }}</u> student in the College of
              <u>{{ data?.college }}</u>
            </p>
            <p style="margin: 0 0 0 30px; font-style: italic; font-size: 9pt;">
              <span style="margin-left: 40px;">Program</span
              ><span style="margin-left: 350px;">Name of College</span>
            </p>
            <p style="margin: 8px 0 0 0;">
              - <u>{{ data?.campus }}</u> Campus, has been officially accepted
              as STUDENT-TRAINEE at
            </p>
            <p
              style="margin: 0; font-style: italic; font-size: 9pt; margin-left: 70px;"
            >
              Name of Campus
            </p>
            <p style="margin: 8px 0 0 30px;">
              <u>{{ data?.company_name }}</u> which is located at
              <u>{{ data?.company_address }}</u
              >.
            </p>
            <p style="margin: 0; font-style: italic; font-size: 9pt;">
              <span style="margin-left: 70px;">Name of Company</span
              ><span style="margin-left: 150px;"
                >Complete Address of the Company</span
              >
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="10" class="detail-field">
        ...
        <tr>
          <td colspan="10" class="detail-label">
            Training Schedule (Hours and Days):
          </td>
          <td colspan="10" class="detail-field">
