    ...
    <div class="document-wrapper">
      ...
      <table class="form-table">
        ...
        <tr class="header-row">
          ...
          <td class="header-cell" colspan="6">Effectivity Date: May 18, 2022</td>
        ...
        <tr>
          <td colspan="20" class="content-text">
            The <u>COMPANY/AGENCY</u>, <u>{{ data?.company_name || '__________________________________' }}</u>, with
            company/agency address at <u>{{ data?.company_address || '__________________________________' }}</u>,
            represented by Company/Agency Representative,
            <u>{{ data?.company_representative || '__________________________________________' }}</u> agrees to accommodate the
            STUDENT TRAINEE, <u>{{ data?.first_name }} {{ data?.middle_name }} {{ data?.last_name }}</u>, who is a
            <u>{{ data?.program || '__________________________________' }}</u> student of the College of
            <u>{{ data?.college || '_____________________________________________' }}</u> of Batangas State
            University, the National Engineering University, for the purpose of
            providing training in various departments of the COMPANY/AGENCY.
          </td>
        </tr>
        ...
        <tr>
          <td colspan="20" class="content-text">
            ...
            <span class="underline-space-short">{{ formatDate(data?.ojt_start_date) }}</span> and will end on
            <span class="underline-space-short">{{ formatDate(data?.ojt_end_date) }}</span>.
          </td>
        </tr>
        ...
        <tr>
          <td colspan="20" class="content-text">
            ...
            employee-employer relationship and the STUDENT TRAINEE shall leave the
            COMPANY/AGENCY free and harmless from any demand, claim or complaint,
            whatsoever arising from this training agreement, except in cases of
            gross negligence, malicious acts and criminal acts by the
            COMPANY/AGENCY or any of its officers and employees.
          </td>
        </tr>
        ...
        <tr>
          <td colspan="20" class="content-text">
            5. The STUDENT TRAINEE shall conform to all the rules and regulations
            of the COMPANY/AGENCY while on training.
          </td>
        </tr>
        ...
        <tr>
          <td colspan="20" class="content-text">
            ...
            a. the STUDENT TRAINEE does not show the required interest, maturity,
            or discipline during the training period, or if there is serious
            misconduct
          </td>
        </tr>
        ...
        <tr>
          <td colspan="20" class="content-text">
            ...
            and finalized. The OJT Coordinator will intervene in order to rectify
            the situation in the interest of all parties concerned.
          </td>
        </tr>
